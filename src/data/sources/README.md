...
- **Local-directory coverage:** all 50 registration numbers matched the snapshot
...
5. All 50 matched records show a validity end date of `Perpetual` in this snapshot. This should not be treated as a substitute for a current SEBI lookup.
